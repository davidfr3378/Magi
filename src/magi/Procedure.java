...
public class Procedure {
    ...
    public void game_intro(){
        ...
        Equipmentt starter_robe = new Equipmentt("Beginner Robe", "Elemental", "Most basic robe. \n\t Given to all beginner mages");
        ...
        */
        ...
        System.out.println("\n--- Your room, No. 213 Dorm 2, Enlightment Magus Academy ---");
        ...
        main_character.displayEquipment();
